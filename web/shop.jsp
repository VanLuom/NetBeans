<%-- 
    Document   : shop
    Created on : Apr 24, 2023, 12:03:56 PM
    Author     : ACER
--%>
                                    ...
                                    <div class="card rounded-0">
                                        ...
                                        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a class="btn btn-success text-white mt-2" href="ProductDetailServlet?product_id=${product.id}"><i class="far fa-eye"></i></a></li>
